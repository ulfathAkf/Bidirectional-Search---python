...
if _name_ == '_main_':
    ...
    my_Graph.AddEdge(3, 10)
    my_Graph.AddEdge(4, 5)
    my_Graph.AddEdge(4, 7)
    my_Graph.AddEdge(5, 8)
    my_Graph.AddEdge(6, 12)
    my_Graph.AddEdge(6, 13)
    my_Graph.AddEdge(7, 6)
    my_Graph.AddEdge(7, 9)
    my_Graph.AddEdge(8, 12)
    my_Graph.AddEdge(9, 13)
    my_Graph.AddEdge(10, 11)
    my_Graph.AddEdge(10, 9)
    my_Graph.AddEdge(11, 9)
    my_Graph.AddEdge(12, 13)
